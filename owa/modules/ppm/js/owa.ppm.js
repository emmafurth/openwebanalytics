...
/*OWA.report.ppm.prototype = {
	userFilter : function(){
		var that = this;
		//var test = this.uber.getOption('autoRefreshResultSets');
		alert("Success! "+this.constructor.uber+".");
		jQuery('#owa_user_list').change( function() { alert("Double Success!"); that.reload(); } );
	}
}*/
/*PPM.prototype = new OWA.report();
PPM.prototype.userFilter = function(){
	var that = this;
	alert("Success!");
	jQuery('#owa_user_list').change( function() { alert("Double Success!"); that.reload(); } );
}*/
...
OWA.report.ppm.prototype ={
	...
	showUserFilter: function(properties) {
		...
		var that = this;
		alert("Success!");
		jQuery('#owa_user_list').change( function() { alert("Double Success!"); that.reload(properties); } );
	},
	reload: function() {
		alert("Triple Success!");
		// add new site_id to properties
		...
		if (current_user != undefined) {
			this.properties['current_user'] = current_user;
		}
		// reload report	
